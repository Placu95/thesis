...
% molti dispositivi connessi (esempi) con trend sempre in aumento (img), dispositivi diversi per capacità computazionali ma anche comunicative
% l'approccio classico ai sistemi distrivuiti pervasivi propone un approccio device-centric (ma...tutti i contro).
% AC propone un approccio top-down, descrizione della soluzione a livello globale astraendo da chi sono i dispositivi, dove eseguono e come comunicano. il focus deve essere....
% API per facilitare sviluppatore (con immagine)
