...
% dire le motivazioni ed introdurre brevemente le varie cose
% discorso simulazioni perchè sono utili e il fatto che simulatori diversi offrono astrazioni diverse, es. Alchemist consente simulazione di programmi protelis astraendo dall'infrastruttura di rete, mentre DingNet è più specializzato su comnicazioni di rete di tipo LORaWAN
